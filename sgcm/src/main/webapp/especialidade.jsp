...
<jsp:useBean id="controller" class="br.ufac.sgcm.controller.EspecialidadeController" scope="page"></jsp:useBean>
<!-- Podemos escrever um codigo java puro entre tags html-->
 <!-- controller da acesso a classe EspecialidadeController -->
